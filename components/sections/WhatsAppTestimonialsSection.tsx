...
const slides: Slide[] = [
  {
    ...
    alt: 'Conversación de WhatsApp — cliente satisfecho: "Ah sí, es perfecto, muy profesional"',
    quote: '«Es la primera vez que me encuentro con un servicio tan profesional como el vuestro»',
  },
  {
    src: '/testimonials/client-2.jpg',
    alt: 'Conversación de WhatsApp — cliente satisfecho: "Muy satisfecho, os contactaré en 1 año"',
    quote: '«Muy satisfecho. Os contactaré dentro de 1 año entonces 👍»',
  },
  {
    src: '/testimonials/client-3.jpg',
    alt: 'Conversación de WhatsApp — cliente satisfecho: "Sí, gracias, funciona bien"',
    quote: '«Sí, gracias, funciona bien 👍 — Muchas gracias ❤️»',
  },
  {
    src: '/testimonials/client-4.jpg',
    alt: 'Conversación de WhatsApp — cliente satisfecho: "Funciona genial"',
    quote: '«Funciona genial. Por cierto, para instalarlo en el otro Fire Stick…»',
  },
];
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <SectionHeader
          label="Opiniones reales de WhatsApp"
          title="Lo que dicen nuestros clientes tras la activación"
          description="Comentarios auténticos de clientes en España — directamente desde su mensajería WhatsApp, tras activar su suscripción VivaceTV."
          dark
          className="mb-14"
        />
        ...
        <div className="flex flex-col items-center gap-8">
          ...
          {/* Dot indicators */}
          <div className="flex items-center gap-2" role="tablist" aria-label="Seleccionar un testimonio">
            {slides.map((_, i) => (
              <button
                key={i}
                type="button"
          ...
          >
            ...
            Conversaciones de WhatsApp auténticas
          </div>
        </div>
      </div>
    </section>
