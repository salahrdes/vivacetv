...
const badges = [
  { icon: <BookOpen size={14} aria-hidden="true" />,    label: 'Guía completa paso a paso' },
  { icon: <Clock size={14} aria-hidden="true" />,       label: 'Instalación en menos de 5 min' },
  { icon: <MessageCircle size={14} aria-hidden="true" />, label: 'Soporte WhatsApp incluido' },
];
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center gap-6">
        ...
        >
          Smart TV Samsung, LG, Fire TV Stick, Android, iPhone, iPad, PC o Mac — sigue nuestra
          guía paso a paso para configurar tu suscripción IPTV España en pocos clics.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mt-2">
          ...
          <a
            href={buildWhatsAppUrl('Hola VivaceTV, necesito ayuda con la instalación')}
            target="_blank"
