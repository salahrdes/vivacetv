    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeader
          ...
          title="¿Por qué elegir VivaceTV para tu IPTV en España?"
          description="Una suscripción IPTV España debe ser sencilla, estable y compatible con tus dispositivos. VivaceTV reúne calidad de imagen, activación rápida, asistencia y experiencia multidispositivo en una interfaz clara y moderna."
          className="mb-14"
