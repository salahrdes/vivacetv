...
export const metadata: Metadata = {
  title: 'Politique de remboursement | VivaceTV',
  description: 'Politique de remboursement de VivaceTV — conditions, délais et procédure pour les demandes de remboursement.',
...
export default function PolitiqueRemboursementPage() {
  return (
    <LegalPageLayout
      ...
      subtitle="Conditions et procédure pour les demandes de remboursement liées à votre abonnement IPTV VivaceTV."
      ...
      sections={[
        ...
        },
        {
          ...
          paragraphs: [
            "VivaceTV s'engage à fournir un service de qualité. Si vous rencontrez un problème que notre équipe ne parvient pas à résoudre, nous examinons les demandes de remboursement au cas par cas.",
        ...
        },
        {
          ...
          paragraphs: [
            "Les demandes de remboursement doivent être formulées par écrit, par email à support@vivacetv.com, dans un délai de 48 heures suivant l'activation du service.",
        ...
        },
        {
          ...
          paragraphs: [
            "Pour toute demande de remboursement ou question relative à notre politique : support@vivacetv.com",
