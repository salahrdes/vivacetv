...
export const metadata: Metadata = {
  title: 'Fournisseur IPTV France Fiable — Qui est ClarioTV ? | IPTV France',
  description:
    'Découvrez ClarioTV, votre fournisseur IPTV France de confiance. +22 000 chaînes HD/4K/8K, serveurs stables, support WhatsApp 24/7. Comment choisir un bon fournisseur IPTV ?',
  keywords: [
  ...
  openGraph: {
    title: 'Fournisseur IPTV France Fiable — Qui est ClarioTV ? | IPTV France',
    description:
      'ClarioTV : fournisseur IPTV France fiable. +22 000 chaînes, HD/4K/8K, AntiFreeze 10.0, support WhatsApp 24/7. Tout ce qu\'il faut savoir pour choisir un bon fournisseur IPTV.',
...
const faqItems = [
  {
    ...
    answer:
      "Un bon fournisseur IPTV se reconnaît à sa stabilité serveur (peu ou pas de coupures), à la régularité des mises à jour des listes de chaînes, à la réactivité de son support client, à la disponibilité d'un essai gratuit et à des avis clients positifs vérifiables. ClarioTV coche tous ces critères.",
  },
  {
    question: 'ClarioTV est-il un fournisseur IPTV légal ?',
    answer:
      "ClarioTV opère dans le respect de la réglementation en vigueur et s'engage à proposer un service de qualité à ses utilisateurs. Nous vous recommandons de consulter notre article sur la légalité de l'IPTV en France pour plus d'informations.",
  },
  {
  ...
  {
    question: 'ClarioTV propose-t-il un essai gratuit ?',
    answer:
      "Oui, ClarioTV propose un test gratuit de 24 heures sur simple demande. Contactez notre équipe via WhatsApp pour en bénéficier avant de vous engager dans un abonnement.",
  },
  {
    question: "Combien coûte un abonnement chez un fournisseur IPTV sérieux ?",
    answer:
      "Un abonnement IPTV sérieux se situe entre 20€ et 80€ selon la durée. Chez ClarioTV, nos offres démarrent à 22,99€ pour 3 mois et vont jusqu'à 74,99€ pour 24 mois — des tarifs compétitifs pour une qualité premium.",
  },
];
...
const trustPillars = [
  ...
  },
  {
    ...
    desc: "Testez ClarioTV gratuitement avant de vous engager. Une pratique rare dans notre secteur, qui témoigne de notre confiance en la qualité de notre service.",
  },
];
...
const selectionCriteria = [
  {
    ...
    body: "La stabilité est le critère n°1. Un fournisseur IPTV fiable doit afficher un uptime proche de 99,9% et intégrer une technologie anti-freeze. Avant de vous abonner, renseignez-vous sur les coupures en consultant les avis clients récents. ClarioTV utilise la technologie AntiFreeze 10.0 testée et validée par des milliers d'utilisateurs.",
  },
  {
    num: '2',
    title: 'Testez avant d\'acheter',
    body: "Tout fournisseur IPTV sérieux propose un essai gratuit. Un service qui refuse tout test ou qui exige un paiement immédiat sans période d'essai est un signal d'alarme. ClarioTV offre 24 heures de test gratuit sur simple demande via WhatsApp.",
  },
  {
    num: '3',
  ...
  },
  {
    ...
    body: "Vérifiez le nombre de chaînes (françaises + internationales + sportives), la disponibilité de la 4K/8K, et l'étendue du catalogue VOD (films et séries). ClarioTV propose +22 000 chaînes et +160 000 contenus en HD/4K/8K.",
  },
  {
    num: '5',
    title: 'Lisez les avis clients',
    body: "Les avis vérifiés sont le meilleur indicateur de la qualité réelle d'un service. Méfiez-vous des services sans aucun avis ou avec uniquement des commentaires génériques. ClarioTV affiche une note de 4,8/5 sur plus de 500 avis vérifiés.",
  },
  {
    num: '6',
    ...
    <>
      ...
      <main id="main-content">
        <PageHero
          ...
          subtitle="Avec des milliers de clients satisfaits, ClarioTV s'impose comme le fournisseur IPTV France de référence. Découvrez pourquoi et comment choisir un bon fournisseur."
        />
        ...
        <section className="py-16 lg:py-24" style={{ backgroundColor: 'var(--color-surface)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-base leading-relaxed" style={{ color: 'var(--color-ink-light)' }}>
              ...
              pour évaluer la fiabilité de ClarioTV.
            </p>
          </div>
        </section>
        ...
        <section className="py-16 lg:py-24" style={{ backgroundColor: 'var(--color-surface)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2
              ...
              style={{ color: 'var(--color-ink)' }}
            >
              Pourquoi ClarioTV est un Fournisseur IPTV de Confiance
            </h2>
        ...
        <section className="py-16 lg:py-24" style={{ backgroundColor: 'var(--color-surface-alt)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-base leading-relaxed mb-4" style={{ color: 'var(--color-ink-light)' }}>
              <strong style={{ color: 'var(--color-ink)' }}>ClarioTV opère en direct</strong>,
