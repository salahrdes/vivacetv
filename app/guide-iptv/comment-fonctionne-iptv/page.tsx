...
export const metadata: Metadata = {
  title: "Comment Fonctionne l'IPTV ? Explication Simple et Complète | ClarioTV",
  description:
  ...
  openGraph: {
    title: "Comment Fonctionne l'IPTV ? Explication Simple et Complète | ClarioTV",
    description:
      "Tout comprendre sur le fonctionnement de l'IPTV : technologie, équipement, connexion et premiers pas avec ClarioTV.",
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Pour une expérience optimale en HD, une connexion de 10 Mbps est suffisante. Pour la 4K, prévoyez au minimum 25 Mbps. ClarioTV est optimisé pour fonctionner correctement dès 15 Mbps pour la majorité des chaînes HD. La stabilité de la connexion est aussi importante que la vitesse brute.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Une playlist M3U est un fichier texte qui contient les adresses URL de tous les flux de chaînes auxquels vous avez accès. Lorsque vous souscrivez à un abonnement IPTV comme ClarioTV, vous recevez une URL M3U ou des identifiants Xtream Codes à configurer dans votre application IPTV préférée. Ce fichier est automatiquement mis à jour pour refléter l'état actuel des chaînes disponibles.",
  },
  {
    question: "Peut-on regarder l'IPTV sur plusieurs appareils en même temps ?",
    answer:
      "Cela dépend de votre abonnement. La plupart des offres IPTV permettent 1 à 2 connexions simultanées. ClarioTV précise le nombre de connexions simultanées incluses dans chaque formule au moment de l'abonnement. Pour regarder sur plusieurs écrans en même temps, certaines formules proposent des connexions multiples.",
  },
];
...
const steps = [
  {
    num: '1',
    title: 'Choisissez votre abonnement ClarioTV',
  ...
  return (
    <>
      ...
      <main id="main-content">
        ...
        <section className="py-16 lg:py-20" style={{ backgroundColor: 'var(--color-surface)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-base leading-relaxed mb-4" style={{ color: 'var(--color-ink-light)' }}>
              ...
              les services IPTV indépendants comme ClarioTV, c'est un accès à un catalogue beaucoup
            ...
            <div className="flex flex-col gap-6">
              ...
              <div>
                ...
                <p className="text-base leading-relaxed" style={{ color: 'var(--color-ink-light)' }}>
                  ...
                  chaînes live qui suivent une grille de programmation. ClarioTV propose +160 000
        ...
        {/* Section 5 — Démarrer avec ClarioTV */}
        <section className="py-16 lg:py-20" style={{ backgroundColor: 'var(--color-surface)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2
              ...
              style={{ color: 'var(--color-ink)' }}
            >
              Comment Démarrer avec ClarioTV en 5 Étapes
            </h2>
