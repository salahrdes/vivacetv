...
export const metadata: Metadata = {
  title: "IPTV sur PC : Les Meilleures Méthodes pour Regarder l'IPTV sur Ordinateur | ClarioTV",
  description:
...
const methods = [
  {
    ...
    steps: [
      ...
      "Collez votre URL M3U ClarioTV dans le champ URL et validez",
  ...
  },
  {
    ...
    steps: [
      ...
      "Entrez vos identifiants ClarioTV et connectez-vous",
