...
export const metadata: Metadata = {
  title: 'IPTV Illégal en France : Amendes, Risques et Comment Rester Légal | ClarioTV',
  description:
      ...
      <main id="main-content">
        ...
        <section className="py-16 lg:py-20" style={{ backgroundColor: 'var(--color-surface-alt)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-base leading-relaxed mb-4" style={{ color: 'var(--color-ink-light)' }}>
              ClarioTV est un service IPTV <strong style={{ color: 'var(--color-ink)' }}>légitimement
              opéré</strong> proposant des abonnements avec <strong style={{ color: 'var(--color-ink)' }}>
              facturation officielle</strong>. Contrairement aux services pirates anonymes, ClarioTV
            ...
            <p className="text-base leading-relaxed mb-4" style={{ color: 'var(--color-ink-light)' }}>
              Les abonnements ClarioTV sont proposés à des tarifs cohérents avec le marché : à partir
            ...
            <p className="text-base leading-relaxed mb-6" style={{ color: 'var(--color-ink-light)' }}>
              En choisissant ClarioTV, vous bénéficiez d'un service stable et documenté — sans exposer
        ...
        <section className="py-16 lg:py-20" style={{ backgroundColor: 'var(--color-surface)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              {[
                { href: '/abonnements', label: 'Voir les offres ClarioTV' },
