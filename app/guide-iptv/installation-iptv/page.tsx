...
const faqItems = [
  {
    ...
    answer:
      "Pour les débutants, IPTV Smarters Pro est l'application la plus simple à configurer. Pour les utilisateurs souhaitant la meilleure interface, TiviMate sur Android TV est le choix premium. Sur Smart TV Samsung, l'application Smart IPTV ou SSIPTV est recommandée. ClarioTV supporte toutes ces applications et vous guidera lors de la configuration.",
  },
  {
    question: "Combien de temps faut-il pour installer l'IPTV ?",
    answer:
      "L'installation prend généralement 5 à 15 minutes selon votre appareil et votre familiarité avec les applications. Une fois votre abonnement ClarioTV actif, la configuration elle-même ne prend que 2 à 3 minutes : installer l'application, entrer l'URL M3U ou les identifiants, et attendre le chargement de la liste de chaînes.",
  },
  {
    question: "Dois-je configurer l'EPG manuellement ?",
    answer:
      "Non, l'EPG (guide des programmes) est généralement inclus dans votre abonnement ClarioTV et se charge automatiquement via l'URL M3U. Dans certaines applications comme TiviMate, il faut activer l'option de chargement automatique de l'EPG dans les paramètres. Notre équipe support peut vous guider pour cette configuration.",
  },
  {
    question: "Que faire si l'IPTV ne fonctionne pas après l'installation ?",
    answer:
      "Vérifiez d'abord votre connexion internet et la validité de vos identifiants. Si la liste de chaînes ne se charge pas, essayez de forcer la mise à jour depuis les paramètres de l'application. En cas de problème persistant, contactez le support ClarioTV via WhatsApp — notre équipe répond en moins de 15 minutes et vous aidera à résoudre le problème étape par étape.",
  },
  {
...
const troubleshootItems = [
  ...
  },
  {
    ...
    solutions: [
      ...
      'Contactez le support ClarioTV pour vérifier la validité de votre lien EPG',
    ],
  },
  {
    ...
    solutions: [
      ...
      'Contactez le support ClarioTV pour réinitialiser vos accès',
    ],
  },
];
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid sm:grid-cols-3 gap-4 mb-6">
              {[
                {
                  num: '1',
                  title: 'Un abonnement ClarioTV actif',
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-4">
              {[
                ...
                {
                  step: 'Étape 2',
                  title: 'Ajouter votre playlist ClarioTV',
                  desc: "Lancez TiviMate et sélectionnez 'Ajouter une playlist'. Choisissez 'URL M3U' et collez l'URL que vous avez reçue de ClarioTV. Si vous avez des identifiants Xtream Codes, sélectionnez 'Xtream Codes' et entrez l'URL du serveur, votre nom d'utilisateur et votre mot de passe.",
                },
                {
                  step: 'Étape 3',
                  title: "Charger l'EPG",
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-4">
              {[
                ...
                {
                  step: 'Étape 3',
                  title: 'Configurer avec vos identifiants ClarioTV',
                  desc: "Dans IPTV Smarters, sélectionnez 'Login with Xtream Codes API' ou 'Add URL/M3U URL' selon le type d'identifiants reçus. Entrez vos informations ClarioTV et validez. La liste de chaînes se charge en 1 à 3 minutes.",
                },
                {
                  step: 'Étape 4',
