...
export const metadata: Metadata = {
  title: 'Application IPTV Android : Les 5 Meilleures Apps en 2025 | ClarioTV',
  description:
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Oui, vos identifiants ClarioTV (URL M3U ou Xtream Codes) peuvent être utilisés simultanément sur plusieurs applications, dans la limite du nombre de connexions simultanées incluses dans votre abonnement. Vous pouvez par exemple utiliser TiviMate sur votre Android TV et IPTV Smarters sur votre téléphone.",
  },
  {
    question: "Quelle application fonctionne le mieux sur Firestick ?",
    answer:
      "IPTV Smarters Pro est disponible directement sur l'Amazon Appstore et optimisé pour l'interface télécommande du Firestick. TiviMate, bien que nécessitant une installation APK sur Firestick, offre une meilleure expérience globale une fois configuré. Notre support ClarioTV peut vous guider pour l'installation sur Firestick.",
  },
  {
    question: "ClarioTV est-il compatible avec toutes les applications IPTV Android ?",
    answer:
      "Oui, ClarioTV est compatible avec toutes les applications IPTV majeures sur Android : TiviMate, IPTV Smarters Pro, Perfect Player, GSE Smart IPTV, Kodi, VLC et bien d'autres. Nous fournissons à la fois des URL M3U et des identifiants Xtream Codes, les deux formats d'authentification les plus répandus.",
  },
];
      ...
      <main id="main-content">
        ...
        <section className="py-16 lg:py-20" style={{ backgroundColor: 'var(--color-surface)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-base leading-relaxed mb-4" style={{ color: 'var(--color-ink-light)' }}>
              Toutes les applications présentées ici sont compatibles avec ClarioTV et supportent
        ...
        <section className="py-16 lg:py-20" style={{ backgroundColor: 'var(--color-surface-alt)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-6">
              <div>
                ...
                <p className="text-base leading-relaxed mb-3" style={{ color: 'var(--color-ink-light)' }}>
                  ...
                  ClarioTV prend moins de 3 minutes.
                </p>
                <p className="text-base leading-relaxed" style={{ color: 'var(--color-ink-light)' }}>
              ...
              <div>
                ...
                <p className="text-base leading-relaxed" style={{ color: 'var(--color-ink-light)' }}>
                  ...
                  l'APK TiviMate. Notre support ClarioTV vous accompagne pas à pas via WhatsApp.
                </p>
              </div>
              <div>
                <h3
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              >
                Prendre un abonnement ClarioTV →
              </Link>
              <Link
