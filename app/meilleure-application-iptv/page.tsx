...
const faqItems = [
  ...
  {
    question: 'Mon application IPTV est-elle compatible avec ClarioTV ?',
    answer:
      "ClarioTV est compatible avec toutes les applications IPTV majeures : TiviMate, IPTV Smarters Pro, GSE Smart IPTV, Perfect Player, OTT Navigator, Kodi, VLC et bien d'autres. Nos abonnements fournissent des URL M3U et des identifiants Xtream Codes universellement compatibles.",
  },
  {
...
const configSteps = [
  {
    step: '1',
    title: 'Obtenez votre abonnement ClarioTV',
    ...
    <>
      ...
      <main id="main-content">
        <PageHero
          ...
          subtitle="Le choix de l'application IPTV est aussi important que celui du fournisseur. Voici notre classement des 7 meilleures apps testées avec ClarioTV."
        />
        ...
        <section className="py-16 lg:py-24" style={{ backgroundColor: 'var(--color-surface)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-base leading-relaxed" style={{ color: 'var(--color-ink-light)' }}>
              ClarioTV fournit des identifiants compatibles avec toutes les applications majeures.
        ...
        <section className="py-16 lg:py-24" style={{ backgroundColor: 'var(--color-surface)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <Link
              ...
              style={{ color: 'var(--color-lime)' }}
            >
              Guide complet : configurer TiviMate avec ClarioTV sur Android →
            </Link>
          </div>
        </section>
        ...
        <section className="py-16 lg:py-24" style={{ backgroundColor: 'var(--color-surface-alt)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-base leading-relaxed mb-6" style={{ color: 'var(--color-ink-light)' }}>
              Pour configurer ClarioTV avec GSE Smart IPTV, suivez ces étapes : ouvrez
            ...
            >
              Obtenir mes identifiants ClarioTV →
            </Link>
          </div>
        </section>
        ...
        <section className="py-16 lg:py-24" style={{ backgroundColor: 'var(--color-surface)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2
              ...
              style={{ color: 'var(--color-ink)' }}
            >
              Comment Configurer Votre Application IPTV avec ClarioTV ?
            </h2>
            ...
            <p className="mt-6 text-sm" style={{ color: 'var(--color-ink-light)' }}>
              ClarioTV est compatible avec TiviMate, IPTV Smarters Pro, GSE Smart IPTV, Perfect
