...
export const metadata: Metadata = {
  title: 'Abonnement IPTV 12 Mois — Meilleur Prix Annuel | ClarioTV Gold',
  description:
    'Abonnement IPTV 12 mois ClarioTV Gold à 44,99€ : accès complet +22 000 chaînes HD/4K/8K pour toute l\'année. Économisez 31% vs le tarif normal. Activation rapide.',
  keywords: [
  ...
  openGraph: {
    title: 'Abonnement IPTV 12 Mois — Meilleur Prix Annuel | ClarioTV Gold',
    description:
      'Abonnement IPTV 12 mois ClarioTV Gold à 44,99€. +22 000 chaînes HD/4K/8K, 3,75€/mois. Économisez 31%. Activation rapide.',
...
const faqItems = [
  {
    ...
    answer:
      "Non. L'abonnement ClarioTV Gold 12 mois est un paiement unique sans renouvellement automatique. À l'expiration, vous choisissez librement si vous souhaitez renouveler votre accès.",
  },
  {
    question: "Que se passe-t-il si je ne suis pas satisfait de mon abonnement 12 mois ?",
    answer:
      "ClarioTV propose une garantie satisfaction. Si vous n'êtes pas satisfait, notre équipe fait tout son possible pour résoudre le problème ou vous propose un remboursement selon nos conditions. Contactez notre support via WhatsApp.",
  },
  {
    ...
    <>
      ...
      <main id="main-content">
        <PageHero
          ...
          subtitle="L'offre annuelle ClarioTV — un seul paiement, 12 mois d'accès complet. La formule préférée de nos clients."
        />
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-8">
              ...
              >
                ...
                <p className="text-base leading-relaxed" style={{ color: 'var(--color-ink-light)' }}>
                  L'offre Gold débloque l'intégralité du catalogue VOD de ClarioTV : +160 000 films et séries en
        ...
        >
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2
              ...
              style={{ color: 'var(--color-ink)' }}
            >
              L'Offre Gold ClarioTV — Tout Ce Qui Est Inclus
            </h2>
