...
const faqItems = [
  {
    ...
    answer:
      "IPTV AZ est disponible en France, mais ses retours utilisateurs sont variables. Le service propose un catalogue d'environ 10 000 chaînes et prend en charge plusieurs appareils. Pour une expérience plus stable et un catalogue plus large, ClarioTV reste l'option recommandée avec +22 000 chaînes et la technologie AntiFreeze 10.0.",
  },
  {
    question: 'IPTV AZ est-il moins cher que ClarioTV ?',
    answer:
      "IPTV AZ affiche des prix variables selon les offres disponibles, ce qui rend la comparaison difficile. ClarioTV propose des tarifs transparents et compétitifs : dès 22,99€ pour 3 mois (offre Bronze) jusqu'à 44,99€ pour 12 mois (offre Gold), soit moins de 3,75€ par mois — l'un des meilleurs rapports qualité/prix du marché.",
  },
  {
    question: 'IPTV AZ propose-t-il un essai gratuit ?',
    answer:
      "IPTV AZ ne propose pas d'essai gratuit à notre connaissance. ClarioTV offre un test gratuit de 24 heures sur simple demande via WhatsApp, sans engagement et sans carte bancaire requise.",
  },
  {
    question: 'Comment migrer d\'IPTV AZ vers ClarioTV ?',
    answer:
      "La migration est simple : contactez ClarioTV via WhatsApp pour obtenir votre essai gratuit 24h. Testez le service sur vos appareils, puis choisissez l'offre adaptée à votre usage. Vos identifiants ClarioTV (URL M3U ou Xtream Codes) vous seront communiqués en moins d'une heure.",
  },
];
...
const tableRows = [
  ...
  { label: 'Prix', competitor: 'Variable', clariotv: 'Transparent dès 22,99€ ✓' },
  { label: 'Essai gratuit', competitor: '❌', clariotv: '✅ 24h' },
  { label: 'Support', competitor: 'Limité', clariotv: '✅ WhatsApp 24/7' },
  { label: 'Stabilité', competitor: 'Variable', clariotv: '✅ AntiFreeze 10.0' },
  { label: 'Mise à jour catalogue', competitor: 'Non régulière', clariotv: '✅ Régulière' },
];
    ...
    <>
      ...
      <main id="main-content">
        <PageHero
          ...
          subtitle="Vous cherchez une alternative à IPTV AZ ? Découvrez pourquoi ClarioTV est le meilleur choix pour votre abonnement IPTV France."
        />
        ...
        <section className="py-16 lg:py-24" style={{ backgroundColor: 'var(--color-surface)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-base leading-relaxed" style={{ color: 'var(--color-ink-light)' }}>
              ...
              client réactif en français, ClarioTV est la meilleure alternative à IPTV AZ disponible
        ...
        <section className="py-16 lg:py-24" style={{ backgroundColor: 'var(--color-surface)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2
              ...
              style={{ color: 'var(--color-ink)' }}
            >
              IPTV AZ vs ClarioTV — Comparatif Détaillé
            </h2>
        ...
        <section className="py-16 lg:py-24" style={{ backgroundColor: 'var(--color-surface-alt)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2
              ...
              style={{ color: 'var(--color-ink)' }}
            >
              Pourquoi ClarioTV est Meilleur qu&apos;IPTV AZ ?
            </h2>
            <p className="text-base leading-relaxed mb-4" style={{ color: 'var(--color-ink-light)' }}>
              ClarioTV propose plus de deux fois plus de chaînes qu&apos;IPTV AZ : +22 000 contre
            ...
            <p className="text-base leading-relaxed mb-4" style={{ color: 'var(--color-ink-light)' }}>
              La transparence tarifaire est un autre point fort de ClarioTV. Contrairement à la
              tarification variable d&apos;IPTV AZ, ClarioTV affiche des prix clairs sans surprise :
            ...
            <p className="text-base leading-relaxed mb-4" style={{ color: 'var(--color-ink-light)' }}>
              ...
              ClarioTV garantit une diffusion fluide en toutes circonstances — là où IPTV AZ peut
              présenter des interruptions selon les retours utilisateurs.
            </p>
            <p className="text-base leading-relaxed" style={{ color: 'var(--color-ink-light)' }}>
              Enfin, le support WhatsApp 24/7 de ClarioTV répond en moins de 15 minutes en français —
        ...
        <section className="py-16 lg:py-24" style={{ backgroundColor: 'var(--color-surface)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2
              ...
              style={{ color: 'var(--color-ink)' }}
            >
              Comment Passer d&apos;IPTV AZ à ClarioTV ?
            </h2>
        ...
        <section className="py-16 lg:py-24" style={{ backgroundColor: 'var(--color-surface-alt)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2
              ...
              style={{ color: 'var(--color-ink)' }}
            >
              Questions Fréquentes — IPTV AZ vs ClarioTV
            </h2>
