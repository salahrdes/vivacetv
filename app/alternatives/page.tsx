...
const faqItems = [
  {
    ...
    answer:
      "ClarioTV est considéré comme la meilleure alternative aux autres services IPTV en France. Il propose un catalogue de +22 000 chaînes, une qualité jusqu'au 8K, la technologie AntiFreeze 10.0 pour une diffusion sans coupure, et un support WhatsApp 24/7 réactif. Son essai gratuit 24h permet de tester avant de s'engager.",
  },
  {
  ...
  {
    question: 'Les alternatives IPTV sont-elles aussi bonnes que ClarioTV ?',
    answer:
      "Selon les retours utilisateurs, la plupart des alternatives IPTV présentent des lacunes par rapport à ClarioTV : catalogue plus limité, stabilité variable, absence d'essai gratuit ou support client peu réactif. ClarioTV se distingue notamment par sa technologie AntiFreeze 10.0 et son support WhatsApp francophone disponible 24h/24.",
  },
];
    ...
    <>
      ...
      <main id="main-content">
        <PageHero
          ...
          subtitle="Vous cherchez la meilleure alternative IPTV en France ? Comparez ClarioTV aux principaux services disponibles et faites le bon choix."
        />
        ...
        <section className="py-16 lg:py-24" style={{ backgroundColor: 'var(--color-surface)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-base leading-relaxed mb-12" style={{ color: 'var(--color-ink-light)' }}>
              Nous avons comparé chaque service à ClarioTV sur les critères qui comptent vraiment :
        ...
        <section className="py-16 lg:py-24" style={{ backgroundColor: 'var(--color-surface-alt)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2
              ...
              style={{ color: 'var(--color-ink)' }}
            >
              Pourquoi ClarioTV est la Meilleure Alternative IPTV ?
            </h2>
            <p className="text-base leading-relaxed mb-8" style={{ color: 'var(--color-ink-light)' }}>
              Après avoir comparé l&apos;ensemble des services disponibles sur le marché français, ClarioTV
              se distingue sur tous les critères essentiels. Voici ce qui fait la différence :
            </p>
            <ul className="flex flex-col gap-4 mb-8">
              {whyClarioTV.map((point, i) => (
