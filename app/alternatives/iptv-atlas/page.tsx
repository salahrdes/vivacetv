...
const faqItems = [
  {
    ...
    answer:
      "IPTV Atlas est davantage orienté vers les contenus arabes et internationaux. Les retours utilisateurs suggèrent que son catalogue de chaînes françaises est moins complet que celui de ClarioTV. Pour une expérience optimale en France, ClarioTV propose +22 000 chaînes dont l'intégralité des chaînes françaises gratuites et payantes.",
  },
  {
    question: 'Quelle est la différence entre IPTV Atlas et AtlasPro IPTV ?',
    answer:
      "IPTV Atlas et AtlasPro IPTV sont deux services distincts, même si leurs noms peuvent prêter à confusion. IPTV Atlas est un service généraliste, tandis qu'AtlasPro IPTV se positionne davantage sur le segment premium du contenu arabe. ClarioTV est une alternative supérieure aux deux pour les utilisateurs français.",
  },
  {
    question: 'IPTV Atlas propose-t-il un essai gratuit ?',
    answer:
      "À notre connaissance, IPTV Atlas ne propose pas d'essai gratuit. ClarioTV offre en revanche un test gratuit de 24 heures sur simple demande via WhatsApp, sans engagement ni carte bancaire requise.",
  },
  {
    question: 'Pourquoi choisir ClarioTV plutôt qu\'IPTV Atlas ?',
    answer:
      "ClarioTV surpasse IPTV Atlas sur tous les critères essentiels : catalogue plus large (+22 000 vs ~12 000 chaînes), qualité vidéo supérieure (8K vs HD/4K), interface moderne, prix plus avantageux sur 12 mois (3,75€/mois avec l'offre Gold), essai gratuit 24h et support WhatsApp 24/7 en français.",
  },
];

const tableRows = [
  { label: 'Chaînes disponibles', competitor: '~12 000', clariotv: '+22 000' },
  { label: 'Qualité max', competitor: 'HD/4K', clariotv: '8K ✓' },
  { label: 'Interface', competitor: 'Datée', clariotv: 'Moderne ✓' },
  { label: 'Prix', competitor: '~20€/mois', clariotv: '3,75€/mois (Gold annuel) ✓' },
  { label: 'Essai gratuit', competitor: '❌', clariotv: '✅' },
  { label: 'Support', competitor: 'Email uniquement', clariotv: '✅ WhatsApp 24/7' },
    ...
    <>
      ...
      <main id="main-content">
        <PageHero
          ...
          title="IPTV Atlas"
          titleHighlight="Avis & Comparaison avec ClarioTV"
          subtitle="Vous cherchez une alternative à IPTV Atlas ? Découvrez pourquoi ClarioTV est le meilleur choix pour votre abonnement IPTV France."
        />
        ...
        <section className="py-16 lg:py-24" style={{ backgroundColor: 'var(--color-surface)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2
              ...
              style={{ color: 'var(--color-ink)' }}
            >
              IPTV Atlas vs ClarioTV — Comparatif Détaillé
            </h2>
        ...
        <section className="py-16 lg:py-24" style={{ backgroundColor: 'var(--color-surface-alt)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2
              ...
              style={{ color: 'var(--color-ink)' }}
            >
              Pourquoi ClarioTV est Meilleur qu&apos;IPTV Atlas ?
            </h2>
            <p className="text-base leading-relaxed mb-4" style={{ color: 'var(--color-ink-light)' }}>
              ClarioTV propose un catalogue presque deux fois plus large qu&apos;IPTV Atlas avec plus de
            ...
            <p className="text-base leading-relaxed mb-4" style={{ color: 'var(--color-ink-light)' }}>
              L&apos;interface de ClarioTV est moderne et intuitive, optimisée pour toutes les résolutions
              d&apos;écran. Contrairement à l&apos;interface datée d&apos;IPTV Atlas, ClarioTV offre une expérience
            ...
            <p className="text-base leading-relaxed mb-4" style={{ color: 'var(--color-ink-light)' }}>
              ...
              3,75€ par mois pour ClarioTV (offre Gold 12 mois à 44,99€), le choix est évident en
              termes de rapport qualité/prix.
            </p>
            <p className="text-base leading-relaxed" style={{ color: 'var(--color-ink-light)' }}>
              Le support client ClarioTV est disponible 24/7 via WhatsApp en français — un avantage
        ...
        <section className="py-16 lg:py-24" style={{ backgroundColor: 'var(--color-surface)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2
              ...
              style={{ color: 'var(--color-ink)' }}
            >
              Comment Passer d&apos;IPTV Atlas à ClarioTV ?
            </h2>
        ...
        <section className="py-16 lg:py-24" style={{ backgroundColor: 'var(--color-surface-alt)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2
              ...
              style={{ color: 'var(--color-ink)' }}
            >
              Questions Fréquentes — IPTV Atlas vs ClarioTV
            </h2>
