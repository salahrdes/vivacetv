...
const faqItems = [
  ...
  {
    question: "Comment configurer ClarioTV avec l'application Televizo ?",
    answer:
      "Après avoir souscrit votre abonnement ClarioTV, vous recevez vos identifiants Xtream Codes ou votre URL M3U via WhatsApp. Dans Televizo, allez dans 'Ajouter une liste' et entrez l'URL M3U fournie. Votre liste de chaînes ClarioTV s'importera automatiquement.",
  },
  {
    question: "Televizo est-il meilleur que TiviMate pour l'IPTV ?",
    answer:
      "TiviMate reste l'application de référence pour Android TV, notamment pour son interface EPG avancée. Televizo est une bonne alternative gratuite, particulièrement sur les appareils Android mobiles. Les deux sont entièrement compatibles avec ClarioTV.",
  },
  {
    question: 'Quel abonnement IPTV utiliser avec Televizo ?',
    answer:
      "ClarioTV est compatible à 100% avec Televizo. Notre abonnement fournit une URL M3U ou des identifiants Xtream Codes directement utilisables dans l'application. Avec notre technologie AntiFreeze 10.0, vous profiterez d'une lecture sans coupure.",
  },
];
...
const configSteps = [
  {
    step: 1,
    title: 'Souscrire un abonnement ClarioTV',
    description:
      "Contactez ClarioTV via WhatsApp pour demander votre essai gratuit 24h ou choisissez directement votre offre (Bronze, Silver, Gold ou Diamond). Vos identifiants vous seront communiqués en moins d'une heure.",
  },
  {
    step: 2,
  ...
  {
    step: 4,
    title: "Entrer votre URL M3U ou identifiants Xtream Codes ClarioTV",
    description:
      "ClarioTV fournit deux formats : une URL M3U à coller directement, ou des identifiants Xtream Codes (serveur, nom d'utilisateur, mot de passe). Choisissez le format qui vous convient et saisissez les informations reçues via WhatsApp.",
  },
  {
    step: 5,
    title: 'Charger votre liste de chaînes et profiter',
    description:
      "Validez la configuration. Televizo va importer automatiquement toutes vos chaînes ClarioTV (+22 000 chaînes). Une fois chargé, vous pouvez naviguer dans le catalogue, utiliser le guide TV (EPG) et regarder en HD, 4K ou 8K.",
  },
];

const clariotvAdvantages = [
    ...
    <>
      ...
      <main id="main-content">
        <PageHero
          ...
          subtitle="Televizo est un lecteur IPTV gratuit pour Android. Pour regarder des chaînes, il vous faut un abonnement IPTV — et ClarioTV est le meilleur choix."
        />
        ...
        <section className="py-16 lg:py-24" style={{ backgroundColor: 'var(--color-surface)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-base leading-relaxed mb-4" style={{ color: 'var(--color-ink-light)' }}>
              ...
              d&apos;un fournisseur comme ClarioTV.
            </p>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-sm" style={{ color: 'var(--color-ink-light)' }}>
                ...
                <strong style={{ color: 'var(--color-lime)' }}> ClarioTV (abonnement)</strong> =
            ...
            <p className="text-base leading-relaxed" style={{ color: 'var(--color-ink-light)' }}>
              ...
              fournisseur de confiance. ClarioTV est 100% compatible avec Televizo et fournit
        ...
        {/* Section 3 — Pourquoi ClarioTV avec Televizo */}
        <section className="py-16 lg:py-24" style={{ backgroundColor: 'var(--color-surface)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2
              className="font-display font-bold text-2xl sm:text-3xl mb-6"
              style={{ color: 'var(--color-ink)' }}
            >
              Pourquoi ClarioTV est le Meilleur Abonnement pour Televizo ?
            </h2>
            <p className="text-base leading-relaxed mb-6" style={{ color: 'var(--color-ink-light)' }}>
              ...
              IPTV de qualité. ClarioTV est le partenaire idéal pour plusieurs raisons :
            </p>
            <ul className="flex flex-col gap-4 mb-8">
              {clariotvAdvantages.map((advantage, i) => (
            ...
            <p className="text-base leading-relaxed" style={{ color: 'var(--color-ink-light)' }}>
              ClarioTV propose également un <strong style={{ color: 'var(--color-ink)' }}>essai gratuit de 24 heures</strong> sur
        ...
        <section className="py-16 lg:py-24" style={{ backgroundColor: 'var(--color-surface-alt)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2
              ...
              style={{ color: 'var(--color-ink)' }}
            >
              Guide de Configuration : Televizo + ClarioTV
            </h2>
            <p className="text-base leading-relaxed mb-8" style={{ color: 'var(--color-ink-light)' }}>
              Configurer ClarioTV dans l&apos;application Televizo est simple et rapide. Suivez ces
            ...
            <div className="mt-8">
              ...
              >
                Obtenir mon abonnement ClarioTV →
              </Link>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 lg:py-24" style={{ backgroundColor: 'var(--color-surface)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-base leading-relaxed" style={{ color: 'var(--color-ink-light)' }}>
              <strong style={{ color: 'var(--color-ink)' }}>Bonne nouvelle :</strong> ClarioTV est
              entièrement compatible avec les deux applications. Que vous utilisiez Televizo sur
              votre téléphone Android ou TiviMate sur votre Android TV, vos identifiants ClarioTV
        ...
        <section className="py-16 lg:py-24" style={{ backgroundColor: 'var(--color-surface-alt)' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2
              ...
              style={{ color: 'var(--color-ink)' }}
            >
              Questions Fréquentes — Televizo et ClarioTV
            </h2>
